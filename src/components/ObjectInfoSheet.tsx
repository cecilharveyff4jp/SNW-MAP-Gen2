      ...
      <div ref={headRef} onPointerDown={onDown} onPointerMove={onMove} onPointerUp={onUp} style={{ cursor: "grab", touchAction: "none", flexShrink: 0 }}>
        <div style={{ background: "var(--accent, #1c7ed6)", color: "#fff", borderTopLeftRadius: 18, borderTopRightRadius: 18, padding: "10px 16px 12px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 10 }}>
            ...
            <button onClick={onClose} onPointerDown={(e) => e.stopPropagation()} onPointerUp={(e) => e.stopPropagation()} aria-label="閉じる" style={{ border: "none", background: "rgba(255,255,255,0.22)", borderRadius: 24, width: 48, height: 48, marginRight: -4, color: "#fff", cursor: "pointer", flexShrink: 0, display: "inline-flex", alignItems: "center", justifyContent: "center", touchAction: "manipulation" }}><Icon name="close" size={20} /></button>
          </div>
        </div>
